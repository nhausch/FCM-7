...
Suggested test/compare command set (copy/paste). These all run *all* methods (spline1,
spline2, barycentric1, piecewise Newton) on the same nodes and print errors + timing.
